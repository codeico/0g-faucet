  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#151923]">
        ...
        <div class="bg-[#1c212e] rounded-xl shadow-2xl overflow-hidden mx-4">
          <div>
            <img className="mx-auto h-12 w-auto" src="0g.png" alt="BANGCODE 0G Testnet Faucet" />
            <h2 class="text-center text-3xl font-bold text-[#64B6AC]">BANGCODE 0G Testnet Faucet</h2>
            <p className="mt-2 text-center text-sm text-gray-600">
              Request tokens for the 0G testnet network
            </a>
          </p>
        </div>
        <div class="bg-[#232836] p-4 mx-6 mb-6 rounded-lg border-l-4 border-[#FFB800]">
          <div class="flex"><div class="flex-shrink-0"><svg class="h-5 w-5 text-[#FFB800]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg></div>
            <div class="ml-3"><h3 class="text-sm font-medium text-[#FFB800]">
              Faucet Limit</h3><div class="mt-1 text-xs text-gray-400">
